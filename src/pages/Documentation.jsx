...
function Documentation() {
  ...
  return (
    <div className="mx-2 sm:mx-4 mt-4 pb-1">
      {currentUser ? (
        <button
      ...
      <div className="relative flex flex-col min-h-[85vh] bg-black items-center justify-center rounded-lg overflow-hidden mb-10 py-6 sm:py-12">
        <div className="space-y-5 sm:space-y-10 text-white px-5 my-auto items-center max-w-xl">
          <div className="flex flex-col sm:flex-row items-center sm:mr-12 justify-center space-y-3 sm:space-y-0 sm:space-x-5">
            <img src="/fullLogo.png" alt="" className="max-h-14 sm:max-h-20" />
